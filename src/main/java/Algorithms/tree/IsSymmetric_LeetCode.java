...
public class IsSymmetric_LeetCode {
    /*
     * Given a binary Algorithms.tree, check whether it is a mirror of itself (ie,
     * symmetric around its center).
     * 
     * For example, this binary Algorithms.tree is symmetric:
     * 
     * 1 / \ 2 2 / \ / \ 3 4 4 3
     * 
     ...
     * iteratively.
     * 
     * confused what "{1,#,2,3}" means? > read more on how binary Algorithms.tree is
     * serialized on OJ.
     * 
     * OJ's Binary Tree Serialization:
     * 
     * The serialization of a binary Algorithms.tree follows a level order traversal, where
     ...
     * 1 / \ 2 3 / 4 \ 5
     * 
     * The above binary Algorithms.tree is serialized as "{1,2,3,#,#,4,#,#,5}".
     */
    //
