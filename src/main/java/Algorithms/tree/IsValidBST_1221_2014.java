...
/**
 * Definition for binary Algorithms.tree
...
public class IsValidBST_1221_2014 {
    ...
    */
    ...
    // BST:
    // 1. Left Algorithms.tree is BST;
    // 2. Right Algorithms.tree is BST;
    // 3. root value is bigger than the max value of left Algorithms.tree and
    // smaller than the min value of the right Algorithms.tree.
    public ReturnType dfs(TreeNode root) {
        ...
        // determine the left Algorithms.tree and the right Algorithms.tree;
    ...
    */
    ...
    public boolean dfs4(TreeNode root) {
        ...
        // Judge the left Algorithms.tree.
        if (!dfs4(root.left)) {
            return false;
        }
        ...
        // Judge the right Algorithms.tree.
        if (!dfs4(root.right)) {
            return false;
        }
