...
public class IsValidBST {
    ...
    public ReturnType isValidBSTHelp(TreeNode root) {
        ...
        /* the left Algorithms.tree and the right Algorithms.tree should both be Valid BST.
        ...
        */
        ...
        // get the min value of the Algorithms.tree;
        ret.min = Math.min(left.min, root.val);

        // get the max value of the Algorithms.tree, consider the right node may be null;
