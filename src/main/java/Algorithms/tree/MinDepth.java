...
public class MinDepth {
    ...
    public int minDepthRec(TreeNode root) {
        ...
        //if there is not left Algorithms.tree, just consider the right Algorithms.tree.
        if (root.left == null) {
            return minDepthRec(root.right) + 1;

            //if there is not right Algorithms.tree, just consider the left Algorithms.tree.
