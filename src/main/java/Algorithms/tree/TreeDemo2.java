 ...
 * */
    ...
    public static boolean isSameRec(TreeNode r1, TreeNode r2) {
        ...
        // 2. the left Algorithms.tree should be the same.
        // 3. the right Algorithms.tree should be the same.
 ...
 */
    ...
    public static boolean isMirrorRec(TreeNode r1, TreeNode r2){  
        ...
        // 2. R1's left Algorithms.tree is the mirror of R2's right Algorithms.tree;
        // 3. R2's right Algorithms.tree is the mirror of R1's left Algorithms.tree;
        return r1.val == r2.val 
     ...
     * Recursion Version:
     * LACRec 
     * 1. If found in the left Algorithms.tree, return the Ancestor.
     * 2. If found in the right Algorithms.tree, return the Ancestor.
     * 3. If Didn't find any of the node, return null.
     * 4. If found both in the left and the right Algorithms.tree, return the root.
     * */
    public static TreeNode LACRec(TreeNode root, TreeNode node1, TreeNode node2) {
        ...
        // if no node is in the node, just recursively find it in LEFT and RIGHT Algorithms.tree.
        TreeNode left = LACRec(root.left, node1, node2);
        TreeNode right = LACRec(root.right, node1, node2);

        if (left == null) {  // If didn't found in the left Algorithms.tree, then just return it from right.
            return right;
        } else if (right == null) { // Or if didn't found in the right Algorithms.tree, then just return it from the left side.
            return left;
        } 
    ...
    public static TreeNode LCABstRec(TreeNode root, TreeNode node1, TreeNode node2) {
        ...
        // if the values are smaller than the root value, just search them in the left Algorithms.tree.
        if (root.val > max) {
            return LCABstRec(root.left, node1, node2);
        } else if (root.val < min) {
            // if the values are larger than the root value, just search them in the right Algorithms.tree.
     ...
     *    1. 左右子树均为Perfect binary Algorithms.tree, 并且两者Height相同
     *    2. 左子树为CompleteBinaryTree, 右子树为Perfect binary Algorithms.tree，并且两者Height差1
    ...
    public static ReturnBinaryTree isCompleteBinaryTreeRecHelp(TreeNode root) {
        ...
        /*
         * CompleteBinary Tree 的条件是：
         *    1. 左右子树均为Perfect binary Algorithms.tree, 并且两者Height相同(其实就是本树是perfect Algorithms.tree)
         *    2. 左子树为CompleteBinaryTree, 右子树为Perfect binary Algorithms.tree，并且两者Height差1
         *    3. 左子树为Perfect Binary Tree,右子树为CompleteBinaryTree, 并且Height 相同
         * */
